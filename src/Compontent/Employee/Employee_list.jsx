...
function Employee_list() {
  ...
  const pageCount = Math.ceil(employeelist.length / postsPerPage);
  ...
  useEffect(() => {
    Employeestate && setemployeeliststate(Employeestate);
  ...
  const searchhandler = () => {
    ...
    newstate = employeelist.filter((items) => {
      ...
      return (
        ...
        items.role?.toLowerCase().includes(seacrh?.toLowerCase().trim())
      );
    });
   
      setemployeeliststate(newstate);
      setsearch();
  }
  //  .....update employeeid.....
                ...
                <div className="row align-items-center">
                  ...
                  <div className="col-auto float-right ml-auto">
                    ...
                    <div className="view-icons">
                      ...
                      <Link
                        to="/Admindashboard/Employee_list"
                        title="Tabular View"
